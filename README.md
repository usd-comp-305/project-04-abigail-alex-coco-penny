...
decisions from childhood to retirement. The game ends at retirement, where a player's bank balance indicates success. This project takes _Life_ a bit deeper where we keep it to one player, but we add genetics, 
...
4. Insurance/Car/House/Insurable: Insurance is a class that manages all insurance premiums for implementation of the Insurable interface (i.e. House and Car) <br>
